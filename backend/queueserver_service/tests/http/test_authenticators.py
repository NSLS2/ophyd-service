...
from queueserver_service.http import authentication as _auth

from queueserver_service.http.authenticators import (
    EntraAuthenticator,
    LDAPAuthenticator,
    OIDCAuthenticator,
...
def test_get_current_principal_preserves_api_key_scopes(sqlite_session, monkeypatch):
    ...
    from queueserver_service.http.database import orm as db_orm
    from queueserver_service.http.database.core import create_user
