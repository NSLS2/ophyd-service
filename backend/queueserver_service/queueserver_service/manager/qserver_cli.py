...
def qserver():
    ...
    logging.getLogger("queueserver_service").setLevel("ERROR")
    ...
    parser = argparse.ArgumentParser(
        ...
        f"queueserver-service version {qserver_version}\n",
...
def qserver_zmq_keys():
    logging.basicConfig(level=logging.WARNING)
    logging.getLogger("queueserver_service").setLevel("INFO")
    ...
    parser = argparse.ArgumentParser(
        ...
        f"ZeroMQ control communication channel.\nqueueserver-service version {qserver_version}\n\n"
