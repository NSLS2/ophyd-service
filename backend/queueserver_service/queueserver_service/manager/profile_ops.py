...
def get_default_startup_dir():
    ...
    """
    pc_path = os.path.join(importlib.resources.files("queueserver_service"), "profile_collection_sim", "")
    return pc_path
...
import sys
import logging
from queueserver_service.manager.profile_tools import global_user_namespace
...
def load_profile_collection_from_ipython(path=None):
    ...
    .. code-block:: python
        ...
        from queueserver_service.manager.profile_ops import load_profile_collection_from_ipython
