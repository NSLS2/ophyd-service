...
from ..common.comms import PipeJsonRpcReceive, default_zmq_control_address_for_server
...
def start_manager():
    ...
    group_http.add_argument(
        ...
        "file verbatim via queueserver_service.http.config.parse_configs. If --http-port is also "
