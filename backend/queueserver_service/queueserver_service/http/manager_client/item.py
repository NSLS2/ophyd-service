...
class BItem:
    """
    Represents a queue item (plan, instruction or function). May be instantiated from
    item type and name plus args/kwargs, from an item dictionary or from another BItem.
    """
...
class BPlan(_BItemSpecialized):
    """Represents a queue item of type 'plan'."""
...
class BInst(_BItemSpecialized):
    """Represents a queue item of type 'instruction'."""
...
class BFunc(_BItemSpecialized):
    """Represents a queue item of type 'function'."""
