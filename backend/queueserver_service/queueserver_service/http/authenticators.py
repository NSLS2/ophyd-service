...
async def exchange_code(
    ...
    # Async client + await so the token exchange does not block the server's
    # event loop for the duration of the IdP round-trip (a synchronous
...
class LDAPAuthenticator(InternalAuthenticator):
    ...
    .. code-block::
        ...
        from queueserver_service.http.authenticators import LDAPAuthenticator
