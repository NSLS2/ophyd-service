...
it may be any alphanumeric string::
  ...
  $ QSERVER_HTTP_SERVER_SINGLE_USER_API_KEY=mykey uvicorn --host localhost --port 60610 queueserver_service.http.server:app
...
{"time": 1629816304.5475085, "msg": "INFO:queueserver_service.manager.manager:Opening the new RE environment ...\n"}
